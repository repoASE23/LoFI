...
# def print_excel_format(final_rouges):
#     line0 = "\tBGL\t\thdfs\tHPC\tProxifier\tspark\tZookeeper\tAvg."
#     line1, line2, line3, line4, line5 = "Pre\t", "Rec\t", "F1\t", "CR\t", "Num\t"
#     for dataset in ["bgl", "hdfs", "HPC", "Proxifier", "spark", "Zookeeper", ]:
#         if dataset in final_rouges:
#             final_rouge = final_rouges[dataset]
#             line1 += f"\t{final_rouge['p']}"
#             line2 += f"\t{final_rouge['r']}"
#             line3 += f"\t{final_rouge['f']}"
#             line4 += f"\t{final_rouge['cr']}"
#             line5 += f"\t{final_rouge['num']}"
